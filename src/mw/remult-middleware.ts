import { GenericRequest, GenericRequestHandler, GenericResponse, GenericRouter, remultMiddlewareBase, RemultMiddlewareOptions, SpecificRoute } from './express-bridge.ts';

export function remultMiddleware(options?:
    RemultMiddlewareOptions) {
    const m = new middleware();
    let app: GenericRouter = Object.assign(m, (req:any, res:any, next:any) => m.handleRequest(req, res, next));
